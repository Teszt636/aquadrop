...
export function GiftSection() {
  ...
  return (
    <section className="bg-[#eef4ff] py-20">
      <div
        id="gift-form"
        className="mx-auto w-full max-w-5xl scroll-mt-8 rounded-[28px] border border-slate-200 bg-white/60 p-5 shadow-[0_18px_50px_rgba(15,23,42,0.08)] backdrop-blur-sm sm:px-6 md:scroll-mt-28 md:p-6 lg:scroll-mt-32 lg:p-7"
      >
