  ...
  return (
    <section className="ds-section bg-transparent" id="gift-campaign">
      <div className="ds-container">
        <div className="relative overflow-hidden rounded-3xl border-2 border-brand-primary/35 bg-gradient-to-br from-brand-light via-white to-success-green/10 px-4 py-6 shadow-[0_18px_55px_-26px_rgba(20,38,64,0.55)] sm:px-6 sm:py-8 md:px-8 md:py-12">
          <div className="pointer-events-none absolute inset-x-0 top-0 h-1.5 rounded-t-3xl bg-gradient-to-r from-brand-primary/80 via-success-green/70 to-brand-primary/80" />
            ...
            <div className="mt-5 grid grid-cols-1 gap-x-4 gap-y-3 md:mt-6 md:grid-cols-2 md:gap-x-6 md:gap-y-5">
              ...
              <label className="grid gap-1 text-sm font-semibold text-slate-700" htmlFor="gift-purchase-date">
                ...
                <input
                  ...
                  onChange={handleChange}
                  disabled={isSubmitting}
                  className="h-10 w-full max-w-full rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-900 outline-none transition focus:border-brand-primary focus:ring-2 focus:ring-brand-primary/20 md:h-11 md:px-4 md:py-3 md:text-base"
                />
              </label>
