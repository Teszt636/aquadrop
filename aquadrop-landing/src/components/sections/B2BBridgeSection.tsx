  ...
  return (
    <section className="py-8 md:py-10" id="partner-atvezeto">
      <div className="ds-container">
        <div className="mx-auto max-w-4xl rounded-3xl border border-white/40 bg-white/55 px-5 py-6 shadow-[0_18px_50px_rgba(15,23,42,0.08)] backdrop-blur-sm md:px-8 md:py-7">
