...
export function AdminLogin() {
  ...
  return (
    <section className="mx-auto mt-20 w-full max-w-md rounded-2xl border border-slate-800 bg-slate-900 p-6 shadow-2xl md:p-8">
      ...
      <p className="mt-2 text-sm text-slate-300">Jelentkezz be email címmel és jelszóval.</p>

      <form onSubmit={onSubmit} className="mt-6 space-y-4">
        <label className="block text-sm font-medium text-slate-200" htmlFor="admin-email">
          Email
        </label>
        <input
          id="admin-email"
